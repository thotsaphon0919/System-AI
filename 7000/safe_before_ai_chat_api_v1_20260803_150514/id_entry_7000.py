...
.uploadWord{flex:0 0 auto;color:#fff;font-size:12px;font-weight:950;letter-spacing:.05em;text-shadow:0 2px 12px #000}.hero.pressing{border-color:rgba(255,138,31,.82);transform:scale(.997)}
  ...
  <main class="wrap">
    <section class="hero" id="idCoverBox" role="button" tabindex="0" aria-label="กดค้างเพื่ออัปโหลดภาพปก INFINI ID">
      ...
      <div class="heroContent">
        ...
        <div class="uploadWord">อัปโหลด</div>
      </div>
    </section>
...
function bindPressTarget(el,target,href=''){
  ...
  el.addEventListener('pointermove',e=>{
    if(Math.abs(e.clientX-startX)>16||Math.abs(e.clientY-startY)>16){moved=true;clear()}
  });
