...
def _media_block(reward_id: str, detail: bool = False) -> str:
    ...
    if info and _kind(info) == "video":
        ...
        media = (
            f'<video src="/normal-reward-media/{safe_id}?v={info.get('stored_name','')}-{info.get('size','')}" '
        ...
        media = (
            f'<img src="/normal-reward-media/{safe_id}?v={info.get('stored_name','')}-{info.get('size','')}" '
